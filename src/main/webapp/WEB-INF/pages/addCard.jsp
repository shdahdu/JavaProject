...
<body>
    ...
    <div class="container">
        <div class="form-card">
            ...
            <form action="${pageContext.request.contextPath}/addCard" method="post" enctype="multipart/form-data">
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label>电话 *</label>
                        <input type="text" name="phone" required placeholder="请输入电话"/>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label>公司</label>
                        <input type="text" name="company" placeholder="请输入公司"/>
                    </div>
                    <div class="form-group">
                        <label>职位</label>
